            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <table class="table table-striped">
                        ...
                        <tbody>
                            <?php $counteKzloopLevel=-1;  if( isset($productsNotRelated) && ( is_array($productsNotRelated) || $productsNotRelated instanceof Traversable ) && sizeof($productsNotRelated) ) foreach( $productsNotRelated as $key1 => $value1 ){ $counteKzloopLevel++; ?>
            ...
            <div class="box box-success">
                ...
                <div class="box-body">
                    <table class="table table-striped">
                        ...
                        <tbody>
                            <?php $counteKzloopLevel=-1;  if( isset($productsRelated) && ( is_array($productsRelated) || $productsRelated instanceof Traversable ) && sizeof($productsRelated) ) foreach( $productsRelated as $key1 => $value1 ){ $counteKzloopLevel++; ?>
