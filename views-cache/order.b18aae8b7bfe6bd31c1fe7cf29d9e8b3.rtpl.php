    ...
    <section class="invoice">
        ...
        <div class="row">
            ...
            <table class="table table-striped">
                ...
                <tbody>
                <?php $counteKzloopLevel=-1;  if( isset($products) && ( is_array($products) || $products instanceof Traversable ) && sizeof($products) ) foreach( $products as $key1 => $value1 ){ $counteKzloopLevel++; ?>
                ...
                <tr>
                    ...
                    <td>Kz<?php echo formatPrice($order["vltotal"]); ?></td>
                </tr>
                <?php } ?>
        ...
        <div class="row">
            ...
            <div class="table-responsive">
                ...
                <tbody><tr>
                    ...
                    <td>Kz<?php echo formatPrice($cart["vlsubtotal"]); ?></td>
                </tr>
                <tr>
                    <th>Frete:</th>
                    <td>Kz<?php echo formatPrice($cart["vlfreight"]); ?></td>
                </tr>
                <tr>
                    <th>Total:</th>
                    <td>Kz<?php echo formatPrice($cart["vltotal"]); ?></td>
                </tr>
                </tbody></table>
            </div>
            </div>
