          ...
          <div class="box-header">
            ...
            <div class="box-body no-padding">
              <table class="table table-striped">
                ...
                <tbody>
                  <?php $counteKzloopLevel=-1;  if( isset($orders) && ( is_array($orders) || $orders instanceof Traversable ) && sizeof($orders) ) foreach( $orders as $key1 => $value1 ){ $counteKzloopLevel++; ?>
                  ...
                  <tr>
                    ...
                    <td>Kz<?php echo formatPrice($value1["vlfreight"]); ?></td>
                    ...
                    <td>
                      ...
                      <a href="/admin/orders/<?php echo htmlspecialchars( $value1["idorder"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/status" class="btn btn-primary btn-xs"><i class="fas fa-pen-square"></i> Status</a>
